        ...
        <div initial= {{ opacity:0,scale:0.5}}
         ...
         className="container text-center space-y-10 py-10 ">
            ...
            <div className='space-y-5'>
                <motion.button variants={slideUp(0.5)} initial='initial' whileInView='animate' className='bg-[#B95134] text-black hover:bg-black hover:text-white py-2 px-4 rounded shadow-sm hover:shadow-md'>
                 Subscribe
                 </motion.button>
